...
func TestCheckCert(t *testing.T) {
	...
	cases := []struct {
		...
		{"192.168.99.100", &auth.Options{}, true, nil, nil},
		{"192.168.99.100", &auth.Options{}, false, nil, ErrCertInvalid{wrappedErr: nil, hostURL: "192.168.99.100"}},
		{"192.168.99.100", &auth.Options{}, false, errCertsExpired, ErrCertInvalid{wrappedErr: errCertsExpired, hostURL: "192.168.99.100"}},
	}
